...
class TasksViewModel @ViewModelInject constructor(
    ...
    fun onAddEditResult(result: Int){
        when(result){
            ADD_TASK_RESULT_OK -> showTaskSavedConfirmaitonMessage("Task added")
            EDIT_TASK_RESULT_OK -> showTaskSavedConfirmaitonMessage("Task updated")
        }
    }

    private fun showTaskSavedConfirmaitonMessage(text: String)=viewModelScope.launch {
